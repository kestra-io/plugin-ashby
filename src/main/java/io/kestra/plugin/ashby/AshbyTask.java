    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.ashby.AshbyTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class AshbyTask extends Task implements RunnableTask<AshbyTask.Output> {
    @Schema(
    ...
    @Override
    public AshbyTask.Output run(RunContext runContext) throws Exception {
